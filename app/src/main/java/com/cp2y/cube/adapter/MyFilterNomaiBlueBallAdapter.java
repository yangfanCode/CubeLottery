 ...
 */
public class MyFilterNomaiBlueBallAdapter extends MyBaseAdapter<String> {
    ...
    private View.OnClickListener listener = view -> {
        ...
        if (call != null) call.onBallSelected(MyFilterNomaiBlueBallAdapter.this, val, selected);
    };
    ...
    public MyFilterNomaiBlueBallAdapter(Context context, int resId, boolean ignore,Set<String>list_select) {
        super(context, resId);
        this.ignore=ignore;
