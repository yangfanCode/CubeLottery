 ...
 */
public class LottoTrendLocateAdapter extends TrendSimpleAdapter {

    private Context context;
    /**红球蓝球类型0到4表示红球，5,6表示蓝球**/
    private int type = 0;
    ...
    public void initNums() {
        ...
        for (int i = 0; i < getCount(); i++) {
            ...
            if (type == 5) {
                ...
                nums.add(issueNumber.getSn().get(1));
            } else {
    ...
    public LottoTrendLocateAdapter(Context context, ConditionModel condition) {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        try {
            ...
            locateView.setRed(type != 5&&type!=6);
