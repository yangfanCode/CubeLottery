 ...
 */
public class MyFilterDanTuoBlueBallAdapter extends MyBaseAdapter<String> {
    ...
    private SparseIntArray ignores = ContextHelper.getActivity(SelectNumFilterActivity.class).getIgnoreBlues();
    private View.OnClickListener listener = view -> {
        ...
        if (call != null) call.onBallSelected(MyFilterDanTuoBlueBallAdapter.this, val, selected);
    };
    ...
    public MyFilterDanTuoBlueBallAdapter(Context context, int resId, boolean ignore,Set<String>list_select) {
        super(context, resId);
        this.ignore=ignore;
