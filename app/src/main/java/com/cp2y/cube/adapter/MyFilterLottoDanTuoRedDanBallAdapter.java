 ...
 */
public class MyFilterLottoDanTuoRedDanBallAdapter extends MyBaseAdapter<String> {
    ...
    private View.OnClickListener listener = view -> {
        ...
        if (call != null) isValid = call.onBeforeSelected(MyFilterLottoDanTuoRedDanBallAdapter.this, val,false);
        if (!isValid) return;
        ...
        if (call != null) call.onBallSelected(MyFilterLottoDanTuoRedDanBallAdapter.this, val, selected);
    };
    ...
    public MyFilterLottoDanTuoRedDanBallAdapter(Context context, int resId, boolean ignore, Set<String> list_select_red) {
        super(context, resId);
