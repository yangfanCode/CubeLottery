 ...
 */
public class MyFilterLottoDanTuoBlueBallAdapter extends MyBaseAdapter<String> {
    ...
    private View.OnClickListener listener = view -> {
        ...
        if (call != null) isValid = call.onLottoBeforeSelected(MyFilterLottoDanTuoBlueBallAdapter.this, val);
        if (!isValid) return;
        ...
        if (call != null) call.onBallSelected(MyFilterLottoDanTuoBlueBallAdapter.this, val, selected);
    };
    ...
    public MyFilterLottoDanTuoBlueBallAdapter(Context context, int resId, boolean ignore, Set<String>list_select) {
        super(context, resId);
        this.ignore=ignore;
