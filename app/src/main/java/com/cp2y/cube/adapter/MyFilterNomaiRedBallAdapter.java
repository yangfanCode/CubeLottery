 ...
 */
public class MyFilterNomaiRedBallAdapter extends MyBaseAdapter<String> {
    ...
    private View.OnClickListener listener = view -> {
        ...
        if (call != null) call.onBallSelected(MyFilterNomaiRedBallAdapter.this, val, selected);
    };
    ...
    public MyFilterNomaiRedBallAdapter(Context context, int resId, boolean ignore,Set<String>list_select) {
        super(context, resId);
        this.ignore=ignore;
