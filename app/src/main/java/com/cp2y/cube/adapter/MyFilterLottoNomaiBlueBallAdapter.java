 ...
 */
public class MyFilterLottoNomaiBlueBallAdapter extends MyBaseAdapter<String> {
    ...
    private View.OnClickListener listener = view -> {
        ...
        if (call != null) call.onBallSelected(MyFilterLottoNomaiBlueBallAdapter.this, val, selected);
    };
    ...
    public MyFilterLottoNomaiBlueBallAdapter(Context context, int resId, boolean ignore, Set<String>list_select) {
        super(context, resId);
        this.ignore=ignore;
