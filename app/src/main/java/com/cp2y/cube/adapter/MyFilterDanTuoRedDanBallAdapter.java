 ...
 */
public class MyFilterDanTuoRedDanBallAdapter extends MyBaseAdapter<String> {
    ...
    private View.OnClickListener listener = view -> {
        ...
        if (call != null) isValid = call.onBeforeSelected(MyFilterDanTuoRedDanBallAdapter.this, val,false);
        if (!isValid) return;
        ...
        if (call != null) call.onBallSelected(MyFilterDanTuoRedDanBallAdapter.this, val, selected);
    };
    ...
    public MyFilterDanTuoRedDanBallAdapter(Context context, int resId, boolean ignore, Set<String> list_select_red) {
        super(context, resId);
