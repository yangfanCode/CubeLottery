 ...
 */
public class MyFilter3DZuXuanAdapter extends BaseAdapter {
    ...
    private SparseIntArray ignores = ContextHelper.getActivity(Select3DNumActivity.class).getIgnoreZuXuan();
    public MyFilter3DZuXuanAdapter(Context context, boolean ignore, Set<String> list_select,Set<String> list_select_dantuo){
    ...
    private View.OnClickListener listener = view -> {
        ...
        if (call != null) isValid = call.onBeforeSelected(MyFilter3DZuXuanAdapter.this, val,false);
        if (!isValid) return;
        ...
        if (call != null) call.onBallSelected(MyFilter3DZuXuanAdapter.this, val, selected);
    };
    //长按监听
    private View.OnLongClickListener longClickListener=(v -> {
        ...
        //点击之前判断
        boolean isValid = true;
        if (call != null) isValid = call.onBeforeSelected(MyFilter3DZuXuanAdapter.this, val,true);
