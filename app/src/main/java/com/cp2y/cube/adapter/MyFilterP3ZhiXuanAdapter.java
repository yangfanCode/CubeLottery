 ...
 */
public class MyFilterP3ZhiXuanAdapter extends BaseAdapter {
    ...
    private SparseIntArray ignores_bai = ContextHelper.getActivity(SelectP3NumActivity.class).getIgnoreBai();//直选遗漏
    private SparseIntArray ignores_shi = ContextHelper.getActivity(SelectP3NumActivity.class).getIgnoreShi();//直选遗漏
    private SparseIntArray ignores_ge = ContextHelper.getActivity(SelectP3NumActivity.class).getIgnoreGe();//直选遗漏
    public MyFilterP3ZhiXuanAdapter(Context context, boolean ignore, Set<String> list_select, int flag){
    ...
    private View.OnClickListener listener = view -> {//点击事件
        ...
        if (call != null) call.onBallSelected(MyFilterP3ZhiXuanAdapter.this, val, selected);
    };
