 ...
 */
public class TrendBigNumberAdapter extends TrendSimpleAdapter implements TrendAdapter<IssueAnalyseDataModel.IssueAnalyse> {
    private int flag=-1;
    ...
    public TrendBigNumberAdapter(Context context, ConditionModel condition, int flag) {
