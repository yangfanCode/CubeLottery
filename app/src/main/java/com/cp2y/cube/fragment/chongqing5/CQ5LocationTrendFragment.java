 ...
 * 定位走势
 */
public class CQ5LocationTrendFragment extends TrendP5BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_cq5_location_trend, container, false);
...
//        });
    ...
    protected void reloadData() {
        ...
        if (condition.getPeriod() != condition.getCurrentPeriod() || condition.getWeekDay() != condition.getCurrentWeekDay()) {//加载期数不相同时再加载
            NetHelper.LOTTERY_API.getIssueNumber(10089, "10002", condition.getPeriod(), condition.getWeekDay(), 1)
                    .doOnTerminate(() -> {
