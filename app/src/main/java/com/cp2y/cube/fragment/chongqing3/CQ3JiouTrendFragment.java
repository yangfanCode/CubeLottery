 ...
 * 奇偶走势图
 */
public class CQ3JiouTrendFragment extends TrendD3BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        dataAdapter1 = new D3TrendOddPatternAdapter(getContext(), condition,5);
        dataAdapter2 = new D3TrendOddNumberAdapter(getContext(), condition,5);
...
//        });
        ...
        tv_submit.setOnClickListener((v) -> {
            ...
            if (tabLayout.getTabAt(0).isSelected()) {
                ...
                if (list_pattern_data != null && list_pattern_data.size() > 0) {
                    ...
                    SingletonMapFilter.registerCQ3Service("7", list_pattern_data);
                }
            } else {
                initDataNumber();
                ...
                if (list_number_data != null && list_number_data.size() > 0) {
                    ...
                    SingletonMapFilter.registerCQ3Service("8", list_number_data);
                }
            }
    ...
    private void reloadView() {
        ...
        if (tag == 0) {
            //标题下方文字
            titleExtLayout.addView(inflater.inflate(R.layout.d3_odd_even_pattern_title, null));
            view_pattern = inflater.inflate(R.layout.trend_3d_odd_pattern_select, null);
    ...
    private void resizeLayout() {
        ...
        relativeLayout.setHsvViewSize(DisplayUtil.dip2px(tabLayout.getSelectedTabPosition() == 0 ? 550f : 506f) - DisplayUtil.dip2px(condition.isShowBaseNum() ? 0f : 70f), DisplayUtil.dip2px(30f * dataAdapter1.getCount() ));//默认设置450dp
    ...
    protected void reloadData() {
        ...
        if (condition.getPeriod() != condition.getCurrentPeriod() || condition.getWeekDay() != condition.getCurrentWeekDay()) {//加载期数不相同时再加载
            NetHelper.LOTTERY_API.getIssueAnalyse(10093, "10019", condition.getPeriod(), condition.getWeekDay())
                    .doOnTerminate(() -> {
