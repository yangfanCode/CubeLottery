 ...
 * 和值走势图
 */
public class CQ5SumTrendFragment extends TrendP5BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_cq5_sum_trend, container, false);
...
//        });
    ...
    private void initListener() {
        tv_submit.setOnClickListener((v -> {
            ...
            if(!TextUtils.isEmpty(sum)){
                ...
                SingletonMapFilter.registerCQ5Service("1", list_data);
            }
    ...
    protected void reloadData() {
        ...
        if (condition.getPeriod() != condition.getCurrentPeriod() || condition.getWeekDay() != condition.getCurrentWeekDay()) {//加载期数不相同时再加载
            NetHelper.LOTTERY_API.getIssueNumber(10089, "10002", condition.getPeriod(), condition.getWeekDay(), 0)
