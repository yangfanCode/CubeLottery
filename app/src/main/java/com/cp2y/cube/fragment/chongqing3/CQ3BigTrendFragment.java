 ...
 * 大小走势图
 */
public class CQ3BigTrendFragment extends TrendD3BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        dataAdapter1 = new D3TrendBigPatternAdapter(getContext(), condition,5);
...
//        });
        ...
        tv_submit.setOnClickListener((v) -> {
            ...
            if (tabLayout.getTabAt(0).isSelected()) {
                ...
                if (list_pattern_data != null && list_pattern_data.size() > 0) {
                    ...
                    SingletonMapFilter.registerCQ3Service("12", list_pattern_data);
                }
            } else {
                initDataNumber();
                ...
                if (list_number_data != null && list_number_data.size() > 0) {
                    ...
                    SingletonMapFilter.registerCQ3Service("13", list_number_data);
                }
            }
    ...
    protected void reloadData() {
        ...
        if (condition.getPeriod() != condition.getCurrentPeriod() || condition.getWeekDay() != condition.getCurrentWeekDay()) {//加载期数不相同时再加载
            NetHelper.LOTTERY_API.getIssueAnalyse(10093, "10004", condition.getPeriod(), condition.getWeekDay())
                    .doOnTerminate(() -> {
