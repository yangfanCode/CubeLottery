 ...
 * 除3余走势图
 */
public class P5Chu3yuTrendFragment extends TrendP5BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRootView = inflater.inflate(R.layout.fragment_p5_chu3yu_trend, container, false);
...
//        });
        ...
        tv_submit.setOnClickListener((v)->{
            ...
            if(tabLayout.getTabAt(0).isSelected()){
                ...
                if(list_pattern_data!=null&&list_pattern_data.size()>0){
                    ...
                    SingletonMapFilter.registerP5Service("9", list_pattern_data);
                }
            }else{
                initDataNumber();
    ...
    protected void reloadData() {
        ...
        if (condition.getPeriod() != condition.getCurrentPeriod() || condition.getWeekDay() != condition.getCurrentWeekDay()) {//加载期数不相同时再加载
            NetHelper.LOTTERY_API.getIssueAnalyse(10004, "10022", condition.getPeriod(), condition.getWeekDay())
