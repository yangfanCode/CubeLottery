 ...
 * 定位走势
 */
public class CQ3SwingTrendFragment extends TrendD3BaseFragment {
...
//        });
    ...
    protected void reloadData() {
        ...
        if (condition.getPeriod() != condition.getCurrentPeriod() || condition.getWeekDay() != condition.getCurrentWeekDay()) {//加载期数不相同时再加载
            NetHelper.LOTTERY_API.getIssueNumber(10093, "10002", condition.getPeriod(), condition.getWeekDay(), 3)
