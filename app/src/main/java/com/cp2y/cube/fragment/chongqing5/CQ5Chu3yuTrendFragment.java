 ...
 * 除3余走势图
 */
public class CQ5Chu3yuTrendFragment extends TrendP5BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRootView = inflater.inflate(R.layout.fragment_cq5_chu3yu_trend, container, false);
        ...
        dataAdapter1 = new TrendDividePatternAdapter(getContext(),condition,4);
        dataAdapter2 = new TrendDivideNumberAdapter(getContext(),condition,4);
...
//        });
        ...
        tv_submit.setOnClickListener((v)->{
            ...
            if(tabLayout.getTabAt(0).isSelected()){
                ...
                if(list_pattern_data!=null&&list_pattern_data.size()>0){
                    ...
                    SingletonMapFilter.registerCQ5Service("9", list_pattern_data);
                }
            }else{
                initDataNumber();
    ...
    private void reloadView() {
        ...
        if (tabLayout.getSelectedTabPosition() == 0) {//选择形态
            hScrollView.addView(inflater.inflate(R.layout.p5_divide_three_pattern_title, null));
            view_pattern=inflater.inflate(R.layout.trend_p5_divide_pattern_select, null);
            ...
            hScrollView.addView(inflater.inflate(R.layout.p5_three_number_title, null));
            view_number=inflater.inflate(R.layout.trend_p5_divide_number_select, null);
    ...
    private void resizeLayout() {
        ...
        relativeLayout.setHsvViewSize(DisplayUtil.dip2px(tabLayout.getSelectedTabPosition() == 0 ?540f:586f) + DisplayUtil.dip2px(condition.isShowBaseNum()?70f:0f), DisplayUtil.dip2px(30f * dataAdapter1.getCount()));//默认设置450dp
    }
    ...
    protected void reloadData() {
        ...
        if (condition.getPeriod() != condition.getCurrentPeriod() || condition.getWeekDay() != condition.getCurrentWeekDay()) {//加载期数不相同时再加载
            NetHelper.LOTTERY_API.getIssueAnalyse(10089, "10022", condition.getPeriod(), condition.getWeekDay())
