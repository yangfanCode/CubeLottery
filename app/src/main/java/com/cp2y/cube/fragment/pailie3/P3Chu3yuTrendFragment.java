 ...
 * 除3余走势图
 */
public class P3Chu3yuTrendFragment extends TrendD3BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        dataAdapter2 = new D3TrendDivideNumberAdapter(getContext(),condition,3);
...
//        });
        ...
        tv_submit.setOnClickListener((v)->{
            ...
            if(tabLayout.getTabAt(0).isSelected()){
                ...
                if(list_pattern_data!=null&&list_pattern_data.size()>0){
                    ...
                    SingletonMapFilter.registerP3Service("9", list_pattern_data);
                }
            }else{
                initDataNumber();
    ...
    private void resizeLayout() {
        ...
        relativeLayout.setHsvViewSize(DisplayUtil.dip2px(tabLayout.getSelectedTabPosition() == 0 ?312f:406f) + DisplayUtil.dip2px(condition.isShowBaseNum()?70f:0f), DisplayUtil.dip2px(30f * dataAdapter1.getCount()));//默认设置450dp
    }
    ...
    protected void reloadData() {
        ...
        if (condition.getPeriod() != condition.getCurrentPeriod() || condition.getWeekDay() != condition.getCurrentWeekDay()) {//加载期数不相同时再加载
            NetHelper.LOTTERY_API.getIssueAnalyse(10003, "10022", condition.getPeriod(), condition.getWeekDay())
