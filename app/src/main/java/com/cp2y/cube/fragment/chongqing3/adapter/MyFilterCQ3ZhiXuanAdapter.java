package com.cp2y.cube.fragment.chongqing3.adapter;
 ...
 */
public class MyFilterCQ3ZhiXuanAdapter extends BaseAdapter {
    ...
    private SparseIntArray ignores_bai = ContextHelper.getActivity(SelectCQ3XingNumActivity.class).getIgnoreBai();//直选遗漏
    private SparseIntArray ignores_shi = ContextHelper.getActivity(SelectCQ3XingNumActivity.class).getIgnoreShi();//直选遗漏
    private SparseIntArray ignores_ge = ContextHelper.getActivity(SelectCQ3XingNumActivity.class).getIgnoreGe();//直选遗漏
    public MyFilterCQ3ZhiXuanAdapter(Context context, boolean ignore, Set<String> list_select, int flag){
    ...
    private View.OnClickListener listener = view -> {//点击事件
        ...
        if (call != null) call.onBallSelected(MyFilterCQ3ZhiXuanAdapter.this, val, selected);
    };
