 ...
 */
public class MyFilterP5ZhiXuanAdapter extends BaseAdapter {
    ...
    private SparseIntArray ignores_wan = ContextHelper.getActivity(SelectP5NumActivity.class).getIgnoreWan();//直选万位遗漏
    private SparseIntArray ignores_qian = ContextHelper.getActivity(SelectP5NumActivity.class).getIgnoreQian();//直选千位遗漏
    private SparseIntArray ignores_bai = ContextHelper.getActivity(SelectP5NumActivity.class).getIgnoreBai();//直选百位遗漏
    private SparseIntArray ignores_shi = ContextHelper.getActivity(SelectP5NumActivity.class).getIgnoreShi();//直选十位遗漏
    private SparseIntArray ignores_ge = ContextHelper.getActivity(SelectP5NumActivity.class).getIgnoreGe();//直选个位遗漏
    public MyFilterP5ZhiXuanAdapter(Context context, boolean ignore, Set<String> list_select, int flag){
    ...
    private View.OnClickListener listener = view -> {//点击事件
        ...
        if (call != null) call.onBallSelected(MyFilterP5ZhiXuanAdapter.this, val, selected);
    };
