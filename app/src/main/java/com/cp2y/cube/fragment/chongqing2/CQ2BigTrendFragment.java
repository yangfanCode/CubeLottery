 ...
 * 大小走势图
 */
public class CQ2BigTrendFragment extends TrendD3BaseFragment {
    ...
    private String[] oddData = {"大大", "大小","小大","小小"};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        dataAdapter1 = new D3TrendBigPatternAdapter(getContext(), condition,7);
...
//        });
        ...
        tv_submit.setOnClickListener((v) -> {
            ...
            if (tabLayout.getTabAt(0).isSelected()) {
                ...
                if (list_pattern_data != null && list_pattern_data.size() > 0) {
                    ...
                    SingletonMapFilter.registerCQ2Service("12", list_pattern_data);
                }
            } else {
                initDataNumber();
                ...
                if (list_number_data != null && list_number_data.size() > 0) {
                    ...
                    SingletonMapFilter.registerCQ2Service("13", list_number_data);
                }
            }
    ...
    private void reloadView() {
        ...
        if (tag == 0) {
            //标题下方文字
            titleExtLayout.addView(inflater.inflate(R.layout.cq2_big_even_pattern_title, null));
            view_pattern = inflater.inflate(R.layout.trend_cq2_big_pattern_select, null);
    ...
    private void resizeLayout() {
        ...
        relativeLayout.setHsvViewSize(DisplayUtil.dip2px(tabLayout.getSelectedTabPosition() == 0 ? 310f : 410f) - DisplayUtil.dip2px(condition.isShowBaseNum() ? 0f : 70f), DisplayUtil.dip2px(30.1f * dataAdapter1.getCount() - 1));//默认设置450dp
    ...
    protected void reloadData() {
        ...
        if (condition.getPeriod() != condition.getCurrentPeriod() || condition.getWeekDay() != condition.getCurrentWeekDay()) {//加载期数不相同时再加载
            NetHelper.LOTTERY_API.getIssueAnalyse(10095, "10004", condition.getPeriod(), condition.getWeekDay())
                    .doOnTerminate(() -> {
