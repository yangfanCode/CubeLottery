 ...
 */
public abstract class TrendP5BaseFragment extends BaseFragment {
    ...
    public void closePop(){
        ...
        if(activity instanceof P5TrendPicActivity){
            P5TrendPicActivity activityD3= (P5TrendPicActivity) getActivity();
            activityD3.ClosePop();
