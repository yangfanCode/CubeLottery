...
import com.cp2y.cube.adapter.MyFilterP3ZhiXuanAdapter;
 ...
 */
public class P3ZhiXuanFragment extends FilterBaseFragment implements BallSelectCall, MyInterface.setSelectNumPopUps, MyInterface.isSavaNumSuccess {
    ...
    private MyFilterP3ZhiXuanAdapter adapter_bai, adapter_shi, adapter_ge;
            ...
            if (loginState) {
                if (list_select_bai.size() > 0 && list_select_shi.size() > 0 && list_select_ge.size() > 0) {
                    if (list_select_bai.size() == 1 && list_select_shi.size() == 1 && list_select_ge.size() == 1) {//单式
                        ...
                        getService(D3LotteryService.class).saveLotteryNumber(list, 0, 3,selectCount);
                    } else {//定位
                        //判断相同号码
                        list_check2.clear();
    ...
    private void initData() {
        ...
        adapter_bai = new MyFilterP3ZhiXuanAdapter(getActivity(), false, list_select_bai, 0);
        gv_bai.setAdapter(adapter_bai);
        adapter_bai.LoadData(list_num);
        adapter_shi = new MyFilterP3ZhiXuanAdapter(getActivity(), false, list_select_shi, 1);
        gv_shi.setAdapter(adapter_shi);
        adapter_shi.LoadData(list_num);
        adapter_ge = new MyFilterP3ZhiXuanAdapter(getActivity(), false, list_select_ge, 2);
