 ...
 */
public class P5TrendLocateAdapter extends TrendSimpleAdapter {
...
//    }
    ...
    public P5TrendLocateAdapter(Context context, ConditionModel condition) {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.item_trend_p5_locate, null);
        }
        try {
            ...
            nums.setTextColor(ColorUtils.NORMAL_GRAY);
