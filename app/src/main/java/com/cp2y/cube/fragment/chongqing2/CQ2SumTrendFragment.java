 ...
 * 和值走势图
 */
public class CQ2SumTrendFragment extends TrendD3BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_cq2_sum_trend, container, false);
        ...
        dataAdapter = new D3TrendSumAdapter(getContext(),condition,7);
...
//        });
    ...
    private void initListener() {
        ...
        tv_submit.setOnClickListener((v)->{
            ...
            if(list_data!=null&&list_data.size()>0){
                ...
                SingletonMapFilter.registerCQ2Service("1", list_data);
            }
    ...
    private void resizeLayout() {
        ...
        relativeLayout.setHsvViewSize(DisplayUtil.dip2px(condition.isShowBaseNum()?680f:610f), DisplayUtil.dip2px(30f * dataAdapter.getCount()));//默认设置450dp
    }
    ...
    protected void reloadData() {
        ...
        if (condition.getPeriod() != condition.getCurrentPeriod() || condition.getWeekDay() != condition.getCurrentWeekDay()) {//加载期数不相同时再加载
            NetHelper.LOTTERY_API.getIssueAnalyse(10095, "10002", condition.getPeriod(), condition.getWeekDay())
