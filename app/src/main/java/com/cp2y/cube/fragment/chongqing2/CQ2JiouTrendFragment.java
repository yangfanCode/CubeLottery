...
import com.cp2y.cube.adapter.D3TrendOddPatternAdapter;
 ...
 * 奇偶走势图
 */
public class CQ2JiouTrendFragment extends TrendD3BaseFragment {
    ...
    private D3TrendOddPatternAdapter dataAdapter1;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRootView = inflater.inflate(R.layout.fragment_cq3_jiou_trend, container, false);
        initSettingDialog(getString(R.string.odd_tips), MapUtils.D3_LOCATE_SUPPORT, new int[]{0,1});
        ...
        dataAdapter1 = new D3TrendOddPatternAdapter(getContext(), condition,7);
        dataAdapter2 = new D3TrendOddNumberAdapter(getContext(), condition,7);
...
//        });
        ...
        tv_submit.setOnClickListener((v) -> {
            ...
            if (tabLayout.getTabAt(0).isSelected()) {
                ...
                if (list_pattern_data != null && list_pattern_data.size() > 0) {
                    ...
                    SingletonMapFilter.registerCQ2Service("7", list_pattern_data);
                }
            } else {
                initDataNumber();
                ...
                if (list_number_data != null && list_number_data.size() > 0) {
                    ...
                    SingletonMapFilter.registerCQ2Service("8", list_number_data);
                }
            }
    ...
    private void reloadView() {
        ...
        if (tag == 0) {
            //标题下方文字
            titleExtLayout.addView(inflater.inflate(R.layout.cq2_odd_even_pattern_title, null));
            view_pattern = inflater.inflate(R.layout.trend_cq2_odd_pattern_select, null);
            ...
            titleExtLayout.addView(inflater.inflate(R.layout.cq2_odd_even_number_title, null));
            view_number = inflater.inflate(R.layout.trend_cq2_odd_number_select, null);
    ...
    private void resizeLayout() {
        ...
        relativeLayout.setHsvViewSize(DisplayUtil.dip2px(tabLayout.getSelectedTabPosition() == 0 ? 310f : 410f) - DisplayUtil.dip2px(condition.isShowBaseNum() ? 0f : 70f), DisplayUtil.dip2px(30f * dataAdapter1.getCount() ));//默认设置450dp
    ...
    protected void reloadData() {
        ...
        if (condition.getPeriod() != condition.getCurrentPeriod() || condition.getWeekDay() != condition.getCurrentWeekDay()) {//加载期数不相同时再加载
            NetHelper.LOTTERY_API.getIssueAnalyse(10095, "10019", condition.getPeriod(), condition.getWeekDay())
                    .doOnTerminate(() -> {
