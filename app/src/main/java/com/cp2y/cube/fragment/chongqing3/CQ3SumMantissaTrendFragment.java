...
import com.cp2y.cube.adapter.D3TrendRangeAdapter;
 ...
 * 跨幅度走势
 */
public class CQ3SumMantissaTrendFragment extends TrendD3BaseFragment {
    ...
    private D3TrendRangeAdapter dataAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_cq3_summantissa_trend, container, false);
        initSettingDialog(getString(R.string.span_tips), MapUtils.D3_LOCATE_SUPPORT, new int[]{1});
        //默认不显示开奖号
        ...
        dataAdapter = new D3TrendRangeAdapter(getContext(),condition,3);//不带含篮球adapter
...
//        });
    ...
    private void initListener() {
        ...
        tv_submit.setOnClickListener((v)->{
            ...
            if(list_data!=null&&list_data.size()>0){
                ...
                SingletonMapFilter.registerCQ3Service("11", list_data);
            }
    ...
    private void resizeLayout() {
        ...
        relativeLayout.setHsvViewSize(DisplayUtil.dip2px(condition.isShowBaseNum()?406f:336f), DisplayUtil.dip2px(30f * dataAdapter.getCount()));//默认设置450dp
    }
    ...
    protected void reloadData() {
        ...
        if (condition.getPeriod() != condition.getCurrentPeriod() || condition.getWeekDay() != condition.getCurrentWeekDay()) {//加载期数不相同时再加载
            NetHelper.LOTTERY_API.getIssueAnalyse(10093, "10027", condition.getPeriod(), condition.getWeekDay())
