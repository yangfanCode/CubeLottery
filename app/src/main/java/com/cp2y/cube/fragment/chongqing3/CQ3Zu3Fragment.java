 ...
 */
public class CQ3Zu3Fragment extends FilterBaseFragment implements BallSelectCall, MyInterface.setSelectNumD3PopUps, MyInterface.isSavaNumSuccess {
            ...
            if (loginState) {
                if ((list_select_nomal.size() + list_select_dantuo.size()) > 1) {
                    ...
                    if (list_select_dantuo.size() == 0) {
                        ...
                        getService(D3LotteryService.class).saveLotteryNumber(list, 2, 5,selectCount);
                    } else {
                        //判断相同号码
                        list_check2.clear();
                        ...
                        CommonUtil.SortCollection(list);//排序
                        getService(D3LotteryService.class).saveLotteryNumber(list, 3, 5,selectCount);
                    }
                }else{
