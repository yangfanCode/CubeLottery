 ...
 */
public class DanTuoFragment extends FilterBaseFragment implements BallSelectCall,MyInterface.setSelectNumD3PopUps,MyInterface.isSavaNumSuccess{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_dantuo, container, false);
        ...
        btn_save.setOnClickListener(view -> {
            ...
            if(loginState) {
                ...
                if (list_select_red1.size() > 0 && list_select_red2.size() > 0 && list_select_blue.size() > 0 && (list_select_red1.size() + list_select_red2.size()) > 5) {
                    list.clear();
                    ...
                    getService(LotteryService.class).saveLotteryNumber(list, 2, 0,selectCount);
                } else if (list_select_red1.size() == 0) {
                    TipsToast.showTips("红胆至少选择1个");
                } else if (list_select_red1.size() + list_select_red2.size() < 6) {
                    TipsToast.showTips("红胆+红拖至少选择6个");
                } else if (list_select_blue.size() == 0) {
                    TipsToast.showTips("请至少选择1个蓝球");
                }
            }else{
