 ...
 * 振幅走势
 */
public class CQ5SwingTrendFragment extends TrendP5BaseFragment {
...
//        });
    ...
    protected void reloadData() {
        ...
        if (condition.getPeriod() != condition.getCurrentPeriod() || condition.getWeekDay() != condition.getCurrentWeekDay()) {//加载期数不相同时再加载
            NetHelper.LOTTERY_API.getIssueNumber(10089, "10002", condition.getPeriod(), condition.getWeekDay(), 3)
                    .doOnTerminate(() -> {
