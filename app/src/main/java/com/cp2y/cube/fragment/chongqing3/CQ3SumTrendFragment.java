 ...
 * 和值走势图
 */
public class CQ3SumTrendFragment extends TrendD3BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_cq3_sum_trend, container, false);
        ...
        dataAdapter = new D3TrendSumAdapter(getContext(),condition,5);
...
//        });
    ...
    private void initListener() {
        ...
        tv_submit.setOnClickListener((v)->{
            ...
            if(list_data!=null&&list_data.size()>0){
                ...
                SingletonMapFilter.registerCQ3Service("1", list_data);
            }
    ...
    protected void reloadData() {
        ...
        if (condition.getPeriod() != condition.getCurrentPeriod() || condition.getWeekDay() != condition.getCurrentWeekDay()) {//加载期数不相同时再加载
            NetHelper.LOTTERY_API.getIssueAnalyse(10093, "10002", condition.getPeriod(), condition.getWeekDay())
