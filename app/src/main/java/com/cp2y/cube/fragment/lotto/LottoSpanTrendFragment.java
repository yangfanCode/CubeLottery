...
import com.cp2y.cube.adapter.TrendRangeAdapter;
 ...
 * 跨幅度走势
 */
public class LottoSpanTrendFragment extends TrendLottoBaseFragment {
    ...
    private TrendRangeAdapter dataAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_lotto_span_trend, container, false);
        initSettingDialog(getString(R.string.span_tips), MapUtils.LOTTO_SPAN_SUPPORT, new int[]{1,2},0);
        //默认不显示开奖号
        ...
        dataAdapter = new TrendRangeAdapter(getContext(),condition,1);
...
//        });
    ...
    private void initListener() {
        ...
        tv_submit.setOnClickListener((v)->{
            ...
            if(list_data!=null&&list_data.size()>0){
                ...
                SingletonMapFilter.registerLottoService("4", list_data);
            }
    ...
    private void resizeLayout() {
        ...
        relativeLayout.setHsvViewSize(DisplayUtil.dip2px(condition.isShowBaseNum()?1062f:906f), DisplayUtil.dip2px(30.1f * dataAdapter.getCount()-1));//默认设置450dp
    }
    ...
    protected void reloadData() {
        ...
        if (condition.getPeriod() != condition.getCurrentPeriod() || condition.getWeekDay() != condition.getCurrentWeekDay()) {//加载期数不相同时再加载
            NetHelper.LOTTERY_API.getIssueAnalyse(10088, "10013", condition.getPeriod(), condition.getWeekDay())
