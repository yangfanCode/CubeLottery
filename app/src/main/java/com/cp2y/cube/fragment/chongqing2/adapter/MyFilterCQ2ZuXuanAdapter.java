 ...
 */
public class MyFilterCQ2ZuXuanAdapter extends BaseAdapter {
    ...
    private SparseIntArray ignores = ContextHelper.getActivity(SelectCQ2XingNumActivity.class).getIgnoreZuXuan();
    public MyFilterCQ2ZuXuanAdapter(Context context, boolean ignore, Set<String> list_select, Set<String> list_select_dantuo){
    ...
    private View.OnClickListener listener = view -> {
        ...
        if (call != null) isValid = call.onBeforeSelected(MyFilterCQ2ZuXuanAdapter.this, val,false);
        if (!isValid) return;
        ...
        if (call != null) call.onBallSelected(MyFilterCQ2ZuXuanAdapter.this, val, selected);
    };
    //长按监听
    private View.OnLongClickListener longClickListener=(v -> {
        ...
        //点击之前判断
        boolean isValid = true;
        if (call != null) isValid = call.onBeforeSelected(MyFilterCQ2ZuXuanAdapter.this, val,true);
