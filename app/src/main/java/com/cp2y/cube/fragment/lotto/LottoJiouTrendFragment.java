 ...
 * 奇偶走势图
 */
public class LottoJiouTrendFragment extends TrendLottoBaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRootView = inflater.inflate(R.layout.fragment_lotto_jiou_trend, container, false);
        ...
        dataAdapter1 = new TrendOddPatternAdapter(getContext(), condition, 1);
        dataAdapter2 = new TrendOddNumberAdapter(getContext(), condition, 1);
...
//        });
        ...
        tv_submit.setOnClickListener((v) -> {
            ...
            if (tabLayout.getTabAt(0).isSelected()) {
                ...
                if (list_pattern_data != null && list_pattern_data.size() > 0) {
                    ...
                    SingletonMapFilter.registerLottoService("7", list_pattern_data);
                }
            } else {
                initDataNumber();
                ...
                if (list_number_data != null && list_number_data.size() > 0) {
                    ...
                    SingletonMapFilter.registerLottoService("8", list_number_data);
                }
            }
    ...
    protected void reloadData() {
        ...
        if (condition.getPeriod() != condition.getCurrentPeriod() || condition.getWeekDay() != condition.getCurrentWeekDay()) {//加载期数不相同时再加载
            NetHelper.LOTTERY_API.getIssueAnalyse(10088, "10019", condition.getPeriod(), condition.getWeekDay())
                    .doOnTerminate(() -> {
