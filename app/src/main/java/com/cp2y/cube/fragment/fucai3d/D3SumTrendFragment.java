 ...
 * 和值走势图
 */
public class D3SumTrendFragment extends TrendD3BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        dataAdapter = new D3TrendSumAdapter(getContext(),condition,2);
...
//        });
    ...
    private void initListener() {
        ...
        tv_submit.setOnClickListener((v)->{
            ...
            if(list_data!=null&&list_data.size()>0){
                ...
                SingletonMapFilter.register3DService("1", list_data);
            }
    ...
    private void resizeLayout() {
        ...
        relativeLayout.setHsvViewSize(DisplayUtil.dip2px(condition.isShowBaseNum()?946f:875f), DisplayUtil.dip2px(30.1f * dataAdapter.getCount()-1));//默认设置450dp
    }
    ...
    protected void reloadData() {
        ...
        if (condition.getPeriod() != condition.getCurrentPeriod() || condition.getWeekDay() != condition.getCurrentWeekDay()) {//加载期数不相同时再加载
            NetHelper.LOTTERY_API.getIssueAnalyse(10001, "10002", condition.getPeriod(), condition.getWeekDay())
