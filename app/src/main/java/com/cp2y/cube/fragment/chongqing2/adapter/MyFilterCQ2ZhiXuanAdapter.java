 ...
 */
public class MyFilterCQ2ZhiXuanAdapter extends BaseAdapter {
    ...
    private SparseIntArray ignores_shi = ContextHelper.getActivity(SelectCQ2XingNumActivity.class).getIgnoreShi();//直选遗漏
    private SparseIntArray ignores_ge = ContextHelper.getActivity(SelectCQ2XingNumActivity.class).getIgnoreGe();//直选遗漏
    public MyFilterCQ2ZhiXuanAdapter(Context context, boolean ignore, Set<String> list_select, int flag){
    ...
    private View.OnClickListener listener = view -> {//点击事件
        ...
        if (call != null) call.onBallSelected(MyFilterCQ2ZhiXuanAdapter.this, val, selected);
    };
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        tv_ignore.setText(String.valueOf(flag==0?ignores_shi.get(position):ignores_ge.get(position)));
