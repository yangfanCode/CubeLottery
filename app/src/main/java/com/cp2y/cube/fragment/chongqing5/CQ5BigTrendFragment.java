 ...
 * 大小走势图
 */
public class CQ5BigTrendFragment extends TrendP5BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRootView = inflater.inflate(R.layout.fragment_cq5_big_trend, container, false);
        ...
        dataAdapter1 = new TrendBigPatternAdapter(getContext(), condition,4);
        dataAdapter2 = new TrendBigNumberAdapter(getContext(), condition,4);
...
//        });
        ...
        tv_submit.setOnClickListener((v)->{
            ...
            if(tabLayout.getTabAt(0).isSelected()){
                ...
                if(list_pattern_data!=null&&list_pattern_data.size()>0) {
                    ...
                    SingletonMapFilter.registerCQ5Service("12", list_pattern_data);
                }
            }else{
                initDataNumber();
                ...
                if(list_number_data!=null&&list_number_data.size()>0){
                    ...
                    SingletonMapFilter.registerCQ5Service("13", list_number_data);
                }
            }
    ...
    private void reloadView() {
        ...
        if (tag == 0) {
            ...
            view_pattern=inflater.inflate(R.layout.trend_p5_big_pattern_select, null);
    ...
    protected void reloadData() {
        ...
        if (condition.getPeriod() != condition.getCurrentPeriod() || condition.getWeekDay() != condition.getCurrentWeekDay()) {//加载期数不相同时再加载
            NetHelper.LOTTERY_API.getIssueAnalyse(10089, "10004", condition.getPeriod(), condition.getWeekDay())
                    .doOnTerminate(() -> {
