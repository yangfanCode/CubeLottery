 ...
 * 奇偶走势图
 */
public class JiouTrendFragment extends TrendBaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        initSettingDialog(getString(R.string.odd_tips), MapUtils.ODD_SUPPORT, new int[]{1,2},0);
        //默认不显示开奖号
        ...
        dataAdapter1 = new TrendOddPatternAdapter(getContext(), condition,0);
        dataAdapter2 = new TrendOddNumberAdapter(getContext(), condition,0);
...
//        });
        ...
        tv_submit.setOnClickListener((v)->{
            ...
            if(tabLayout.getTabAt(0).isSelected()){
                ...
                if(list_pattern_data!=null&&list_pattern_data.size()>0) {
                    ...
                    SingletonMapFilter.registerService("7", list_pattern_data);
                }
            }else{
                initDataNumber();
                ...
                if(list_number_data!=null&&list_number_data.size()>0){
                    ...
                    SingletonMapFilter.registerService("8", list_number_data);
                }
            }
    ...
    private void reloadView() {
        ...
        if (tag == 0) {
            titleExtLayout.addView(inflater.inflate(R.layout.odd_even_pattern_title, null));
            view_pattern=inflater.inflate(R.layout.trend_odd_pattern_select, null);
    ...
    private void resizeLayout() {
        ...
        ViewUtils.showViewsVisible(condition.isCalcBlue(), relativeLayout.findViewById(R.id.trend_blue_num), relativeLayout.findViewById(R.id.trend_blue_num1), relativeLayout.findViewById(R.id.trend_blue_num2), relativeLayout.findViewById(R.id.trend_blue_num3),
                relativeLayout.findViewById(R.id.trend_blue_select), relativeLayout.findViewById(R.id.trend_blue_select1));
        ...
        relativeLayout.setHsvViewSize(DisplayUtil.dip2px(tabLayout.getSelectedTabPosition() == 0?676f:996f) - DisplayUtil.dip2px(condition.isShowBaseNum()?0f:156f) - DisplayUtil.dip2px(condition.isCalcBlue()?0f:(tabLayout.getSelectedTabPosition() == 0?60f:100f)), DisplayUtil.dip2px(30.1f * dataAdapter1.getCount()-1));//默认设置450dp
    }
    ...
    protected void reloadData() {
        ...
        int count = condition.isCalcBlue()?7:6;
        if (titleLayout != null) {
        ...
        if (condition.getPeriod() != condition.getCurrentPeriod() || condition.getWeekDay() != condition.getCurrentWeekDay()) {//加载期数不相同时再加载
            NetHelper.LOTTERY_API.getIssueAnalyse(10002, "10019", condition.getPeriod(), condition.getWeekDay())
