 ...
 * 除3余走势图
 */
public class LottoChu3yuTrendFragment extends TrendLottoBaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRootView = inflater.inflate(R.layout.fragment_lotto_chu3yu_trend, container, false);
        initSettingDialog(getString(R.string.divide_tips), MapUtils.LOTTO_DIVIDE_SUPPORT, new int[]{1,2},0);
        ...
        dataAdapter1 = new TrendDividePatternAdapter(getContext(),condition,1);
        dataAdapter2 = new TrendDivideNumberAdapter(getContext(),condition,1);
...
//        });
        ...
        tv_submit.setOnClickListener((v)->{
            ...
            if(tabLayout.getTabAt(0).isSelected()){
                ...
                if(list_pattern_data!=null&&list_pattern_data.size()>0){
                    ...
                    SingletonMapFilter.registerLottoService("9", list_pattern_data);
                }
            }else{
                initDataNumber();
    ...
    private void reloadView() {
        ...
        if (tabLayout.getSelectedTabPosition() == 0) {//选择形态
            hScrollView.addView(inflater.inflate(R.layout.lotto_divide_three_pattern_title, null));
    ...
    private void resizeLayout() {
        ...
        ViewUtils.showViewsVisible(condition.isCalcBlue(), relativeLayout.findViewById(R.id.lotto_trend_blue_pattern1),relativeLayout.findViewById(R.id.lotto_trend_blue_pattern2), relativeLayout.findViewById(R.id.trend_blue_num1),relativeLayout.findViewById(R.id.trend_blue_num2), relativeLayout.findViewById(R.id.trend_blue_num3),
                relativeLayout.findViewById(R.id.trend_blue_select), relativeLayout.findViewById(R.id.trend_blue_select1), relativeLayout.findViewById(R.id.trend_blue_select2), relativeLayout.findViewById(R.id.trend_blue_select3),relativeLayout.findViewById(R.id.trend_blue_num4),relativeLayout.findViewById(R.id.trend_blue_num5),relativeLayout.findViewById(R.id.trend_blue_num6));//蓝球隐藏
        relativeLayout.setHsvViewSize(DisplayUtil.dip2px(tabLayout.getSelectedTabPosition() == 0 ?720f:766f) + DisplayUtil.dip2px(condition.isShowBaseNum()?156f:0f) - DisplayUtil.dip2px( condition.isCalcBlue()?0f:180f), DisplayUtil.dip2px(30.1f * dataAdapter1.getCount()-1));//默认设置450dp
    }
    ...
    protected void reloadData() {
        ...
        if (condition.getPeriod() != condition.getCurrentPeriod() || condition.getWeekDay() != condition.getCurrentWeekDay()) {//加载期数不相同时再加载
            NetHelper.LOTTERY_API.getIssueAnalyse(10088, "10022", condition.getPeriod(), condition.getWeekDay())
