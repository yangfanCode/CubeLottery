...
import com.cp2y.cube.adapter.D3TrendDivideNumberAdapter;
import com.cp2y.cube.adapter.D3TrendDividePatternAdapter;
 ...
 * 除3余走势图
 */
public class D3Chu3yuTrendFragment extends TrendD3BaseFragment {
    ...
    private D3TrendDividePatternAdapter dataAdapter1;
    private D3TrendDivideNumberAdapter dataAdapter2;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRootView = inflater.inflate(R.layout.fragment_3d_chu3yu_trend, container, false);
        ...
        dataAdapter1 = new D3TrendDividePatternAdapter(getContext(),condition);
        dataAdapter2 = new D3TrendDivideNumberAdapter(getContext(),condition,2);
...
//        });
        ...
        tv_submit.setOnClickListener((v)->{
            ...
            if(tabLayout.getTabAt(0).isSelected()){
                ...
                if(list_pattern_data!=null&&list_pattern_data.size()>0){
                    ...
                    SingletonMapFilter.register3DService("9", list_pattern_data);
                }
            }else{
                initDataNumber();
    ...
    private void reloadView() {
        ...
        if (tabLayout.getSelectedTabPosition() == 0) {//选择形态
            hScrollView.addView(inflater.inflate(R.layout.d3_divide_three_pattern_title, null));
            view_pattern=inflater.inflate(R.layout.trend_d3_divide_pattern_select, null);
            ...
            hScrollView.addView(inflater.inflate(R.layout.d3_three_number_title, null));
            view_number=inflater.inflate(R.layout.trend_d3_divide_number_select, null);
    ...
    private void resizeLayout() {
        ...
        relativeLayout.setHsvViewSize(DisplayUtil.dip2px(tabLayout.getSelectedTabPosition() == 0 ?312f:406f) + DisplayUtil.dip2px(condition.isShowBaseNum()?70f:0f), DisplayUtil.dip2px(30.1f * dataAdapter1.getCount()-1));//默认设置450dp
    }
    ...
    protected void reloadData() {
        ...
        if (condition.getPeriod() != condition.getCurrentPeriod() || condition.getWeekDay() != condition.getCurrentWeekDay()) {//加载期数不相同时再加载
            NetHelper.LOTTERY_API.getIssueAnalyse(10001, "10022", condition.getPeriod(), condition.getWeekDay())
