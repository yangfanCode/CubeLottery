 ...
 * 跨幅度走势
 */
public class CQ5SpanTrendFragment extends TrendP5BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_cq5_span_trend, container, false);
        ...
        dataAdapter = new D3TrendRangeAdapter(getContext(),condition,4);
...
//        });
    ...
    private void initListener() {
        ...
        tv_submit.setOnClickListener((v)->{
            ...
            if(list_data!=null&&list_data.size()>0){
                ...
                SingletonMapFilter.registerCQ5Service("4", list_data);
            }
    ...
    protected void reloadData() {
        ...
        if (condition.getPeriod() != condition.getCurrentPeriod() || condition.getWeekDay() != condition.getCurrentWeekDay()) {//加载期数不相同时再加载
            NetHelper.LOTTERY_API.getIssueAnalyse(10089, "10013", condition.getPeriod(), condition.getWeekDay())
