 ...
 * 和值走势图
 */
public class LottoSumTrendFragment extends TrendLottoBaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_lotto_sum_trend, container, false);
        initSettingDialog(getString(R.string.sum_tips), MapUtils.LOTTO_SUM_SUPPORT, new int[]{1},0);
        //默认不显示开奖号
        ...
        dataAdapter = new TrendSumAdapter(getContext(),condition,1);
...
//        });
    ...
    private void initListener() {
        tv_submit.setOnClickListener((v -> {
            ...
            if(!TextUtils.isEmpty(sum)){
                ...
                SingletonMapFilter.registerLottoService("1", list_data);
            }
    ...
    protected void reloadData() {
        ...
        int[] sums = condition.isCalcBlue()?MapUtils.LOTTO_SUM_NOMAL_BLUE_NUMS:MapUtils.LOTTO_SUM_BLUE_NUMS;
