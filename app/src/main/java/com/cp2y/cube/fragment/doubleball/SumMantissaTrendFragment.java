 ...
 * 和尾数走势
 */
public class SumMantissaTrendFragment extends TrendBaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        initSettingDialog(getString(R.string.span_tips), MapUtils.ODD_SUPPORT, new int[]{1,2},0);
        //默认不显示开奖号
        ...
        dataAdapter = new TrendSumMantissaAdapter(getContext(),condition);//带含篮球
...
//        });
    ...
    private void initListener() {
        ...
        tv_submit.setOnClickListener((v)->{
            ...
            if(list_data!=null&&list_data.size()>0){
                ...
                SingletonMapFilter.registerService("11", list_data);
            }
    ...
    protected void onConditionChanged(MyTrendDialogSupportAdapter adapter) {
        ...
        //下方控制隐藏
        ViewUtils.showViewsVisible(condition.isCalcBlue(),view_span,tv_submit,HScrollView);
    ...
    protected void reloadData() {
        ...
        if (condition.getPeriod() != condition.getCurrentPeriod() || condition.getWeekDay() != condition.getCurrentWeekDay()) {//加载期数不相同时再加载
            NetHelper.LOTTERY_API.getIssueAnalyse(10002, "10027", condition.getPeriod(), condition.getWeekDay())
