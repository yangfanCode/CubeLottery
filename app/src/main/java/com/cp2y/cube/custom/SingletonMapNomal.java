...
public class SingletonMapNomal {
    ...
    public static int calcLotteryCount() {
        int totalCount = 0;
        for (Iterator<Map.Entry<String, List<String>>> it = SingletonMapNomal.getMap().entrySet().iterator(); it.hasNext(); ) {//优先计算实际彩票数量
