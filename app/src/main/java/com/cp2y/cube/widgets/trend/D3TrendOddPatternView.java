 ...
 */
public class D3TrendOddPatternView extends View {
    ...
    public D3TrendOddPatternView(Context context) {
        super(context);
    }

    public D3TrendOddPatternView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public D3TrendOddPatternView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        try {
            ...
            if (currentNum > -1) {
                ...
                //数据
                SparseArray<String> map_data=(flag==7?MapUtils.MAP_CQ2_ODD_INDEX:MapUtils.MAP_3D_ODD_INDEX);
