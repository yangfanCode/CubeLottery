 ...
 */
public class LottoTrendBaseView extends View {
   ...
   static {
    ...
    public LottoTrendBaseView(Context context) {
        super(context);
    }

    public LottoTrendBaseView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public LottoTrendBaseView(Context context, AttributeSet attrs, int defStyleAttr) {
