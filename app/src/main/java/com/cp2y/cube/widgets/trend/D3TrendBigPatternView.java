 ...
 */
public class D3TrendBigPatternView extends View {
    ...
    public D3TrendBigPatternView(Context context) {
        super(context);
    }

    public D3TrendBigPatternView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public D3TrendBigPatternView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setPatterns(int currentNum, int prevNum, int nextNum, List<Integer> miss) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        try {
            ...
            int autoSize=(flag==7?4:8);//奇偶形态列数8个从0开始
            ...
            if (currentNum > -1) {
                ...
                SparseArray<String> map_data=(flag==7?MapUtils.MAP_CQ2_BIG_INDEX:MapUtils.MAP_3D_BIG_INDEX);
