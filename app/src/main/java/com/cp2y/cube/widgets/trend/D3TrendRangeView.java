 ...
 */
public class D3TrendRangeView extends View {
    ...
    public D3TrendRangeView(Context context) {
        super(context);
    }

    public D3TrendRangeView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public D3TrendRangeView(Context context, AttributeSet attrs, int defStyleAttr) {
