 ...
 */
public class D3TrendSumView extends View {
    ...
    static {
        ...
        size2 = res.getDimension(R.dimen.trend_item_height);
    }
    ...
    public D3TrendSumView(Context context) {
        super(context);
    }

    public D3TrendSumView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public D3TrendSumView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        try {
            ...
            int autoSize=(flag==7?19:28);//和值列数28个从0开始 2星19
