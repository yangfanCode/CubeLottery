...
/**
 * 分区形态遗漏activity  展示双色球,奇偶,大小,除3余遗漏
 */
public class PartIgnoreActivity extends DoubleBaseActivity implements MyInterface.IgnoreDateChange,MyInterface.IgnoreIsBlue{
    ...
    private void initListener() {
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            @Override
            public void onTabSelected(TabLayout.Tab tab) {reloadIgnoreData();}
            @Override
        ...
        tv_submit.setOnClickListener((v) -> {
            if(list_divideNum_check!=null&&list_divideNum_check.size()>0&&pos==3&&tabLayout.getSelectedTabPosition()==0){
                ...
                if(list_divide_pattern!=null&&list_divide_pattern.size()>0){
                    ...
                    SingletonMapFilter.registerService("9", list_divide_pattern);
                }
                ...
                if(list_odd_num!=null&&list_odd_num.size()>0) {
                    ...
                    SingletonMapFilter.registerService("8", list_odd_num);
                }
                ...
                if(list_odd_pattern!=null&&list_odd_pattern.size()>0) {
                    ...
                    SingletonMapFilter.registerService("7", list_odd_pattern);
                }
                ...
                if(list_big_num!=null&&list_big_num.size()>0) {
                    ...
                    SingletonMapFilter.registerService("13", list_big_num);
                }
                ...
                if(list_big_pattern!=null&&list_big_pattern.size()>0) {
                    ...
                    SingletonMapFilter.registerService("12", list_big_pattern);
                }
            }
    ...
    private void initData() {
        ...
        adapter=new PartIgnoreAdapter(this,0);
    ...
    private void initView() {
        ...
        data_condition_num=new ArrayList<>();//接收接口数据
    ...
    public void addHscrollview(int pos,boolean type){
        ...
        if(pos==3){//除3余控件初始化
            ...
            list_dividePattern_check.clear();
                view=LayoutInflater.from(this).inflate(type==true?R.layout.ignore_divide_number_select:R.layout.ignore_divide_pattern_select,null);
            ...
            if(type){
                ...
                view=LayoutInflater.from(this).inflate(pos==5?R.layout.ignore_odd_pattern_select:R.layout.ignore_big_pattern_select,null);
        ...
        NetHelper.LOTTERY_API.getConditionMissTrend("10002",type,date,targetID).subscribe(new SafeOnlyNextSubscriber<IgnoreTrendNumModel>(){
            ...
            public void onNext(IgnoreTrendNumModel args) {
                ...
                if((pos==3||pos==5||pos==6)&&tabLayout.getSelectedTabPosition()==1&&type==5){
                    data_condition_pattern.remove(data_condition_pattern.size()-1);//不含蓝球删除最后一条
                }
                adapter.loadData(data_condition_pattern,pos,tabLayout.getSelectedTabPosition());
            }
            ...
            if(tabLayout.getSelectedTabPosition()==0){//除3余个数排序
                ...
                if(type){//次数占比排序
                    if(scale_sort_condition_pattern){
                        setBiBigSort(data_condition_pattern,isBlue?7:6);
                    }else{//倒序
                        setBiSmallSort(data_condition_pattern,isBlue?7:6);
                    }
                    ...
                    if(emerge_sort_condition_pattern){
                        setEmergeBigSort(data_condition_pattern,isBlue?7:6);
                    }else{//倒序
                        setEmergeSmallSort(data_condition_pattern,isBlue?7:6);
                    }
