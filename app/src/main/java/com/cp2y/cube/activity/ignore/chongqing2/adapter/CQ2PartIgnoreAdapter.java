 ...
 */
public class CQ2PartIgnoreAdapter extends BaseAdapter {
    private int maxLeft=0,maxRight=0,pos=0;
    ...
    public CQ2PartIgnoreAdapter(Context context){
        this.context=context;
        inflater=LayoutInflater.from(context);
    }
    @Override
    public int getCount() {
        return list!=null&&list.size()==2?(list.get(0).size()+list.get(1).size()+2):0;
    }
