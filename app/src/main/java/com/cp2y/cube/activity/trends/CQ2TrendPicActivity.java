...
import com.cp2y.cube.activity.ignore.chongqing2.IgnoreCQ2Activity;
import com.cp2y.cube.activity.ignore.chongqing2.PartIgnoreCQ2Activity;
import com.cp2y.cube.custom.GuideFlag;
import com.cp2y.cube.custom.TipsToast;
import com.cp2y.cube.fragment.TrendD3BaseFragment;
import com.cp2y.cube.fragment.chongqing2.CQ2BigTrendFragment;
import com.cp2y.cube.fragment.chongqing2.CQ2Chu3yuTrendFragment;
import com.cp2y.cube.fragment.chongqing2.CQ2JiouTrendFragment;
import com.cp2y.cube.fragment.chongqing2.CQ2LocationTrendFragment;
import com.cp2y.cube.fragment.chongqing2.CQ2SpanTrendFragment;
import com.cp2y.cube.fragment.chongqing2.CQ2SumMantissaTrendFragment;
import com.cp2y.cube.fragment.chongqing2.CQ2SumTrendFragment;
import com.cp2y.cube.fragment.chongqing2.CQ2SwingTrendFragment;
import com.cp2y.cube.network.subscriber.SafeOnlyNextSubscriber;
import com.cp2y.cube.services.CommonService;
import com.cp2y.cube.utils.CommonUtil;

public class CQ2TrendPicActivity extends BaseActivity {
    private AlertDialog dialog=null;
    private int pos;
    private String lotteryName;
    private PopupWindow popupWindow = null;
    private String[] title_array = {"定位走势", "振幅走势", "跨度走势", "除3余走势", "和值走势", "奇偶走势", "大小走势", "和尾数走势"};
    private static Class[] TREND_FRAGMENTS = {CQ2LocationTrendFragment.class, CQ2SwingTrendFragment.class, CQ2SpanTrendFragment.class, CQ2Chu3yuTrendFragment.class, CQ2SumTrendFragment.class, CQ2JiouTrendFragment.class, CQ2BigTrendFragment.class, CQ2SumMantissaTrendFragment.class};
    /**
     * 走势图
     **/
    ...
    private void ignoreListener() {
        ...
        if (pos == 2 ||  pos == 4 ||  pos == 7) {
            intent.setClass(CQ2TrendPicActivity.this, IgnoreCQ2Activity.class);
            intent.putExtra("pos", pos);
            startActivity(intent);
        } else if(pos==1){
            setTipDialog();
        }else{
            intent.setClass(CQ2TrendPicActivity.this, PartIgnoreCQ2Activity.class);
            intent.putExtra("pos", pos);
            startActivity(intent);
        }
    }
    ...
    public void showSubTitles() {
        if (popupWindow == null) {
            View contentView = LayoutInflater.from(CQ2TrendPicActivity.this)
