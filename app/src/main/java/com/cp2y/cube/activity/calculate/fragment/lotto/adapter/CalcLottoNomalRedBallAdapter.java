 ...
 */
public class CalcLottoNomalRedBallAdapter extends MyBaseAdapter<String> {
    ...
    private View.OnClickListener listener = view -> {
        ...
        if (call != null) call.onBallSelected(CalcLottoNomalRedBallAdapter.this, val, selected);
    };
    ...
    public CalcLottoNomalRedBallAdapter(Context context, int resId, boolean ignore, Set<String>list_select) {
        super(context, resId);
        this.ignore=ignore;
