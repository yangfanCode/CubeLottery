...
import com.cp2y.cube.activity.ignore.chongqing3.IgnoreCQ3Activity;
import com.cp2y.cube.activity.ignore.chongqing3.PartIgnoreCQ3Activity;
import com.cp2y.cube.custom.GuideFlag;
import com.cp2y.cube.custom.TipsToast;
import com.cp2y.cube.fragment.TrendD3BaseFragment;
import com.cp2y.cube.fragment.chongqing3.CQ3BigTrendFragment;
import com.cp2y.cube.fragment.chongqing3.CQ3Chu3yuTrendFragment;
import com.cp2y.cube.fragment.chongqing3.CQ3JiouTrendFragment;
import com.cp2y.cube.fragment.chongqing3.CQ3LocationTrendFragment;
import com.cp2y.cube.fragment.chongqing3.CQ3SpanTrendFragment;
import com.cp2y.cube.fragment.chongqing3.CQ3SumMantissaTrendFragment;
import com.cp2y.cube.fragment.chongqing3.CQ3SumTrendFragment;
import com.cp2y.cube.fragment.chongqing3.CQ3SwingTrendFragment;
import com.cp2y.cube.network.subscriber.SafeOnlyNextSubscriber;
import com.cp2y.cube.services.CommonService;
import com.cp2y.cube.utils.CommonUtil;

public class CQ3TrendPicActivity extends BaseActivity {
    private AlertDialog dialog=null;
    private int pos;
    private String lotteryName;
    private PopupWindow popupWindow = null;
    private String[] title_array = {"定位走势", "振幅走势", "跨度走势", "除3余走势", "和值走势", "奇偶走势", "大小走势", "和尾数走势"};
    private static Class[] TREND_FRAGMENTS = {CQ3LocationTrendFragment.class, CQ3SwingTrendFragment.class, CQ3SpanTrendFragment.class, CQ3Chu3yuTrendFragment.class, CQ3SumTrendFragment.class, CQ3JiouTrendFragment.class, CQ3BigTrendFragment.class, CQ3SumMantissaTrendFragment.class};
    /**
     * 走势图
     **/
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public boolean onDoubleTap(MotionEvent e) {
                getService(CommonService.class).runDelay(150).subscribe(new SafeOnlyNextSubscriber<Long>() {
                    ...
                    public void onNext(Long args) {
                        ...
                        TrendD3BaseFragment fragment = (TrendD3BaseFragment) getSupportFragmentManager().findFragmentByTag("TrendFragment");
        ...
        setContentView(R.layout.activity_3d_trend_pic);
    ...
    private void ignoreListener() {
        ...
        if (pos == 2 ||  pos == 4 ||  pos == 7) {
            intent.setClass(CQ3TrendPicActivity.this, IgnoreCQ3Activity.class);
            intent.putExtra("pos", pos);
            startActivity(intent);
        } else if(pos==1){
            setTipDialog();
        }else{
            intent.setClass(CQ3TrendPicActivity.this, PartIgnoreCQ3Activity.class);
            intent.putExtra("pos", pos);
            startActivity(intent);
        }
    }
    ...
    public void showSubTitles() {
        if (popupWindow == null) {
            View contentView = LayoutInflater.from(CQ3TrendPicActivity.this)
