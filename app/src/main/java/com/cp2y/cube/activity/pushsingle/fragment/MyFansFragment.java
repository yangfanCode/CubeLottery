 ...
 * 我的粉丝页面
 */
public class MyFansFragment extends Fragment implements MyInterface.SubscribePersonal{
    ...
    public void initData() {
        ...
        NetHelper.LOTTERY_API.getAttentionFansList(LoginSPUtils.getInt("id", 0),LoginSPUtils.getInt("id", 0),1,currentPage,10)
            ...
            public void onNext(AttentionFansListModel args) {
                ...
                if(args.getItem()!=null&&args.getItem().size()>0){
                    ...
                    layView.setTypeEnum(NotLoginForOptional.TypeEnum.NO_FANS);
                    layView.setBtnOnClickListener((v -> CommonUtil.openActicity(getActivity(),SelectSingleActivity.class,null)));
                }
            }
    ...
    private void initView(View rootView) {
        ...
        lv = (PullToRefreshListView) rootView. findViewById(R.id.my_fans_lv);
        lv.setMode(PullToRefreshBase.Mode.BOTH);
        lv_child=lv.getRefreshableView();
        lv_child.setFooterDividersEnabled(false);
        adapter=new MyAttentionFansAdapter(getActivity(),false);
