...
import com.cp2y.cube.activity.numlibrary.adapter.P5NumberAdapter;
 ...
 */
public class P5LibraryFragment extends Fragment {
    private P5NumberAdapter adapter = null;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //删除号码库
        FileUtils.cleanInternalFiles(new File(FileUtils.P5_PATH));
        ...
        adapter = new P5NumberAdapter(getActivity(),4);
        //添加头布局
    ...
    private void refreshData() {
        currPage = 0;
        NetHelper.LOTTERY_API.getNumberLibrary(LoginSPUtils.getInt("id",0), 10004, 0, ++currPage, 0)
