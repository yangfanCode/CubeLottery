 ...
 */
public class CalcLottoDanTuoBlueHouTuoBallAdapter extends MyBaseAdapter<String> {
    ...
    private View.OnClickListener listener = view -> {
        ...
        if (call != null) isValid = call.onLottoBeforeSelected(CalcLottoDanTuoBlueHouTuoBallAdapter.this, val);
        if (!isValid) return;
        ...
        if (call != null) call.onBallSelected(CalcLottoDanTuoBlueHouTuoBallAdapter.this, val, selected);
    };
    ...
    public CalcLottoDanTuoBlueHouTuoBallAdapter(Context context, int resId, boolean ignore, Set<String>list_select) {
        super(context, resId);
        this.ignore=ignore;
