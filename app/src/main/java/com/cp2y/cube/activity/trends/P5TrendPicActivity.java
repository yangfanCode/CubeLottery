...
import com.cp2y.cube.fragment.pailie5.P5BigTrendFragment;
import com.cp2y.cube.fragment.pailie5.P5Chu3yuTrendFragment;
import com.cp2y.cube.fragment.pailie5.P5JiouTrendFragment;
import com.cp2y.cube.fragment.pailie5.P5LocationTrendFragment;
import com.cp2y.cube.fragment.pailie5.P5SpanTrendFragment;
import com.cp2y.cube.fragment.pailie5.P5SumMantissaTrendFragment;
import com.cp2y.cube.fragment.pailie5.P5SumTrendFragment;
import com.cp2y.cube.fragment.pailie5.P5SwingTrendFragment;
import com.cp2y.cube.network.subscriber.SafeOnlyNextSubscriber;
import com.cp2y.cube.services.CommonService;
import com.cp2y.cube.utils.CommonUtil;

public class P5TrendPicActivity extends BaseActivity {
    private AlertDialog dialog=null;
    private String lotteryName;
    private int pos;
    private PopupWindow popupWindow = null;
    private String[] title_array = {"定位走势", "振幅走势", "跨度走势", "除3余走势", "和值走势", "奇偶走势", "大小走势", "和尾数走势"};
    private static Class[] TREND_FRAGMENTS = {P5LocationTrendFragment.class, P5SwingTrendFragment.class, P5SpanTrendFragment.class, P5Chu3yuTrendFragment.class, P5SumTrendFragment.class, P5JiouTrendFragment.class, P5BigTrendFragment.class, P5SumMantissaTrendFragment.class};
    /**
     * 走势图
     **/
    ...
    private void ignoreListener() {
        ...
        if (pos == 2 ||  pos == 4 ||  pos == 7) {
            intent.setClass(P5TrendPicActivity.this, IgnoreP5Activity.class);
            intent.putExtra("pos", pos);
            startActivity(intent);
        } else if(pos==1){
            setTipDialog();
        }else{
            intent.setClass(P5TrendPicActivity.this, PartIgnoreP5Activity.class);
            intent.putExtra("pos", pos);
            startActivity(intent);
        }
    }
    ...
    public void showSubTitles() {
        if (popupWindow == null) {
            View contentView = LayoutInflater.from(P5TrendPicActivity.this)
