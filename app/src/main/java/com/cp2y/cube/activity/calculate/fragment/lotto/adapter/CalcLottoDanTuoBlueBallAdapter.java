 ...
 */
public class CalcLottoDanTuoBlueBallAdapter extends MyBaseAdapter<String> {
    ...
    private View.OnClickListener listener = view -> {
        ...
        if (call != null) isValid = call.onLottoBeforeSelected(CalcLottoDanTuoBlueBallAdapter.this, val);
        if (!isValid) return;
        ...
        if (call != null) call.onBallSelected(CalcLottoDanTuoBlueBallAdapter.this, val, selected);
    };
    ...
    public CalcLottoDanTuoBlueBallAdapter(Context context, int resId, boolean ignore, Set<String>list_select) {
        super(context, resId);
        this.ignore=ignore;
