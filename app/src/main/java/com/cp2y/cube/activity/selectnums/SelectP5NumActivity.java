...
import com.cp2y.cube.fragment.pailie5.P5ConditionFragment;
import com.cp2y.cube.fragment.pailie5.P5ZhiXuanFragment;
...
public class SelectP5NumActivity extends BaseActivity implements SensorEventListener {
    private int tabSelectPos = 0;
    private List<Fragment> list = new ArrayList<>();
    private Toolbar conditionBar, normalBar;
    private FragmentManager fm = getSupportFragmentManager();
    private P5ConditionFragment conditionFragment = new P5ConditionFragment();
    ...
    private void initListener() {
        ...
        ignore.setOnClickListener(view -> {
            ...
            isIgnore = !isIgnore;
            P5ZhiXuanFragment fragment0 = (P5ZhiXuanFragment) list.get(0);
    ...
    private void initData() {
        //遗漏接口数据
        NetHelper.LOTTERY_API.getD3CurrentLotteryMiss("10004")
        ...
        P5ZhiXuanFragment zhixuanFragment = new P5ZhiXuanFragment();
    ...
    public void editData(List<String>list, String key){
        onBackPressed();
        P5ZhiXuanFragment fragment0 = (P5ZhiXuanFragment) this.list.get(0);
    ...
    protected void onDestroy() {
        ...
        SingletonMapFilter.getP5Map().clear();
