...
import com.cp2y.cube.fragment.fucai3d.D3ConditionFragment;
import com.cp2y.cube.fragment.fucai3d.D3ZhiXuanFragment;
import com.cp2y.cube.fragment.fucai3d.D3Zu3Fragment;
import com.cp2y.cube.fragment.fucai3d.D3Zu6Fragment;
...
public class Select3DNumActivity extends BaseActivity implements SensorEventListener {
    private int tabSelectPos = 0;
    private List<Fragment> list = new ArrayList<>();
    private Toolbar conditionBar, normalBar;
    private TabLayout tablayout;
    private FragmentManager fm = getSupportFragmentManager();
    private D3ConditionFragment conditionFragment = new D3ConditionFragment();
    ...
    private void initListener() {
        ...
        ignore.setOnClickListener(view -> {
            ...
            isIgnore = !isIgnore;
            D3ZhiXuanFragment fragment0 = (D3ZhiXuanFragment) list.get(0);
            fragment0.switchIgnore();
            D3Zu3Fragment fragment1 = (D3Zu3Fragment) list.get(1);
            fragment1.switchIgnore();
            D3Zu6Fragment fragment2 = (D3Zu6Fragment) list.get(2);
    ...
    private void switchDialog(int position) {
        AlertDialog.Builder builder = new AlertDialog.Builder(Select3DNumActivity.this);
        View view = LayoutInflater.from(Select3DNumActivity.this).inflate(R.layout.selectnum_3d_tabswitch, null);
    ...
    private void initData() {
        //遗漏接口数据
        NetHelper.LOTTERY_API.getD3CurrentLotteryMiss("10001")
        ...
        D3ZhiXuanFragment zhixuanFragment = new D3ZhiXuanFragment();
        D3Zu3Fragment zu3Fragment = new D3Zu3Fragment();
        D3Zu6Fragment zu6fragment = new D3Zu6Fragment();
    ...
    public void editData(List<String>list, String key, int keyNum){
        onBackPressed();
        D3ZhiXuanFragment fragment0 = (D3ZhiXuanFragment) this.list.get(0);
        D3Zu3Fragment fragment1 = (D3Zu3Fragment) this.list.get(1);
        D3Zu6Fragment fragment2 = (D3Zu6Fragment) this.list.get(2);
    ...
    protected void onDestroy() {
        ...
        //销毁清空数据 初始化
        SingletonMap3D.getMap().clear();
        SingletonMapFilter.get3dMap().clear();
