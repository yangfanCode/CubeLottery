package com.cp2y.cube.activity.calculate.fragment.p5.adapter;
 ...
 */
public class CalcP5ZhiXuanAdapter extends BaseAdapter {
    ...
    public CalcP5ZhiXuanAdapter(Context context, boolean ignore, Set<String> list_select, int flag){
    ...
    private View.OnClickListener listener = view -> {//点击事件
        ...
        if (call != null) call.onBallSelected(CalcP5ZhiXuanAdapter.this, val, selected);
    };
