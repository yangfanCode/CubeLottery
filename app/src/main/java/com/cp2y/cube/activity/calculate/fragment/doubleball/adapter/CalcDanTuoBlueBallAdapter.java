 ...
 */
public class CalcDanTuoBlueBallAdapter extends MyBaseAdapter<String> {
    ...
    private View.OnClickListener listener = view -> {
        ...
        if (call != null) call.onBallSelected(CalcDanTuoBlueBallAdapter.this, val, selected);
    };
    ...
    public CalcDanTuoBlueBallAdapter(Context context, int resId, boolean ignore, Set<String>list_select) {
        super(context, resId);
        this.ignore=ignore;
