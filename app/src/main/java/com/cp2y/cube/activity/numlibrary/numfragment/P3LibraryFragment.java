 ...
 */
public class P3LibraryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new D3NumberAdapter(getActivity(),3);
        //添加头布局
    ...
    private void refreshData() {
        currPage = 0;
        NetHelper.LOTTERY_API.getNumberLibrary(LoginSPUtils.getInt("id",0), 10003, 0, ++currPage, 0)
