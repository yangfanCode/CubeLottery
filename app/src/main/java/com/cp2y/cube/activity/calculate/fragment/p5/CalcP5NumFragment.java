 ...
 */
public class CalcP5NumFragment extends Fragment implements MyInterface.SetCalcIssue{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_calc_p5_num, container, false);
        initView(rootView);
        initData();
        initListener();
        return rootView;
    ...
    private void initListener() {
        tvAdd.setOnClickListener((v -> {
                P5CalcFragment fragment= (P5CalcFragment) CalcP5NumFragment.this.getParentFragment();
                fragment.setAddMode();
        }));
                ...
                subscriber.onNext(file);
                    ...
                    .subscribe(new SafeOnlyNextSubscriber<Object>() {
                        ...
                        public void onNext(Object args) {
                            super.onNext(args);
                            NetHelper.LOTTERY_API.calcLottery((File)args, 10004, issue, 1, false, true)
    ...
    private void initData() {
        ...
        listView.setOnItemClickListener((adapterView, view1, i, l) -> {//跳转编辑
            ...
            P5CalcFragment fragment= (P5CalcFragment) CalcP5NumFragment.this.getParentFragment();
            fragment.editData(list, entry.getKey());
        });
    ...
    private File getJson(){
        ...
        for(int i=0,size=list.size();i<size;i++){
            ...
            if(lotteryAdapter.getItemViewType(i)==0){//直选单式
                ...
                calcCashModel.playType="9";
            }else if(lotteryAdapter.getItemViewType(i)==1){//直选定位
                calcCashModel.number= CalcCashUtils.saveP5LocationNum(entry.getValue());
                calcCashModel.playType="10";
            }
    ...
    public void setCalcIssue(String issue) {
        if(TextUtils.isEmpty(issue)){
            tvIssue.setText("(排列5)".concat(issue));
        } else {
            this.issue = issue;
            tvIssue.setText("(排列5 ".concat(issue).concat("期)"));
        }
    }
}
