 ...
 */
public class CalcP3Zu3Fragment extends Fragment implements BallSelectCall{
    ...
    private void numSet(int pos1, int pos2) {
        P3CalcFragment fragment= (P3CalcFragment) CalcP3Zu3Fragment.this.getParentFragment();
...
//        }
    ...
    private void saveNum(int type, ArrayList<String> listfilter_zu3, int click) {
        ...
        P3CalcFragment fragment= (P3CalcFragment) CalcP3Zu3Fragment.this.getParentFragment();
        if (type == 2) {//编辑模式
            SingletonMapP3.editDelete(fragment.getKey(), listfilter_zu3);
        } else if (type == 1) {//添加号码
            SingletonMapP3.registerService(SingletonMapP3.sign_sort + "_" + click, listfilter_zu3);
            click++;
            ...
            SingletonMapP3.registerService(CommonUtil.cutFirstKey(fragment.getKey()) + "_" + click, listfilter_zu3);
            click++;
        }
        fragment.gotoConditionPage();
    }
