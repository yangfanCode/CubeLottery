...
import com.cp2y.cube.fragment.fucai3d.D3BigTrendFragment;
import com.cp2y.cube.fragment.fucai3d.D3Chu3yuTrendFragment;
import com.cp2y.cube.fragment.fucai3d.D3JiouTrendFragment;
import com.cp2y.cube.fragment.fucai3d.D3LocationTrendFragment;
import com.cp2y.cube.fragment.fucai3d.D3SpanTrendFragment;
import com.cp2y.cube.fragment.fucai3d.D3SumMantissaTrendFragment;
import com.cp2y.cube.fragment.fucai3d.D3SumTrendFragment;
import com.cp2y.cube.fragment.fucai3d.D3SwingTrendFragment;
import com.cp2y.cube.network.subscriber.SafeOnlyNextSubscriber;
import com.cp2y.cube.services.CommonService;
import com.cp2y.cube.utils.CommonUtil;

public class D3TrendPicActivity extends BaseActivity {
    private AlertDialog dialog=null;
    private String lotteryName;
    private int pos;
    private PopupWindow popupWindow = null;
    private String[] title_array = {"定位走势", "振幅走势", "跨度走势", "除3余走势", "和值走势", "奇偶走势", "大小走势","和尾数走势"};
    private static Class[] TREND_FRAGMENTS = {D3LocationTrendFragment.class, D3SwingTrendFragment.class, D3SpanTrendFragment.class, D3Chu3yuTrendFragment.class, D3SumTrendFragment.class, D3JiouTrendFragment.class, D3BigTrendFragment.class ,D3SumMantissaTrendFragment.class};
    /**
     * 走势图
     **/
    ...
    private void ignoreListener() {
        ...
        if (pos == 2 ||  pos == 4||  pos == 7) {
            intent.setClass(D3TrendPicActivity.this, Ignore3DActivity.class);
            intent.putExtra("pos", pos);
            startActivity(intent);
        } else if(pos==1){
            setTipDialog();
        }else{
            intent.setClass(D3TrendPicActivity.this, PartIgnore3DActivity.class);
            intent.putExtra("pos", pos);
            startActivity(intent);
        }
    }
    ...
    public void showSubTitles() {
        if (popupWindow == null) {
            View contentView = LayoutInflater.from(D3TrendPicActivity.this)
