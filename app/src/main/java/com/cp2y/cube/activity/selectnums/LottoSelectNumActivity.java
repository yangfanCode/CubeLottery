...
import com.cp2y.cube.fragment.lotto.LottoConditionFragment;
import com.cp2y.cube.fragment.lotto.LottoDanTuoFragment;
import com.cp2y.cube.fragment.lotto.LottoNomalFragment;
...
public class LottoSelectNumActivity extends BaseActivity implements SensorEventListener {
    ...
    private LottoConditionFragment conditionFragment = new LottoConditionFragment();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lotto_select_num);
        setMainTitle("过滤条件");
        ...
        LottoNomalFragment nomalFragment = new LottoNomalFragment();
        LottoDanTuoFragment danTuoFragment = new LottoDanTuoFragment();
        ...
        ignore.setOnClickListener(view -> {
            ...
            isIgnore=!isIgnore;
            LottoNomalFragment fragment0 = (LottoNomalFragment) list.get(0);
            fragment0.switchIgnore();
            LottoDanTuoFragment fragment1 = (LottoDanTuoFragment) list.get(1);
            fragment1.switchIgnore();
        });
        NetHelper.LOTTERY_API.getCurrentLotteryMiss("10088")
    ...
    public LottoConditionFragment getConditionFragment() {
    ...
    public void editData(List<String>list, String key, boolean isNormal){
        onBackPressed();
        LottoNomalFragment fragment0 = (LottoNomalFragment) this.list.get(0);
        LottoDanTuoFragment fragment1 = (LottoDanTuoFragment) this.list.get(1);
    ...
    protected void onDestroy() {
        ...
        SingletonMapFilter.getLottoMap().clear();
