package com.cp2y.cube.activity.calculate.fragment.doubleball.adapter;
 ...
 */
public class CalcDanTuoRedTuoBallAdapter extends MyBaseAdapter<String> {
    ...
    private View.OnClickListener listener = view -> {
        ...
        if (call != null) isValid = call.onBeforeSelected(CalcDanTuoRedTuoBallAdapter.this, val,false);
        if (!isValid) return;
        ...
        if (call != null) call.onBallSelected(CalcDanTuoRedTuoBallAdapter.this, val, selected);
    };
    ...
    public CalcDanTuoRedTuoBallAdapter(Context context, int resId, boolean ignore, Set<String>list_select_red) {
        super(context, resId);
        this.ignore = ignore;
