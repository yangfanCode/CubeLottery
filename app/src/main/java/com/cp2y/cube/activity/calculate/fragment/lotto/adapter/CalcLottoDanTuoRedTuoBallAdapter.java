 ...
 */
public class CalcLottoDanTuoRedTuoBallAdapter extends MyBaseAdapter<String> {
    ...
    private View.OnClickListener listener = view -> {
        ...
        if (call != null) isValid = call.onBeforeSelected(CalcLottoDanTuoRedTuoBallAdapter.this, val,false);
        if (!isValid) return;
        ...
        if (call != null) call.onBallSelected(CalcLottoDanTuoRedTuoBallAdapter.this, val, selected);
    };
    ...
    public CalcLottoDanTuoRedTuoBallAdapter(Context context, int resId, boolean ignore, Set<String>list_select_red) {
        super(context, resId);
        this.ignore = ignore;
