 ...
 */
public class CalcNomalRedBallAdapter extends MyBaseAdapter<String> {
    ...
    private View.OnClickListener listener = view -> {
        ...
        if (call != null) call.onBallSelected(CalcNomalRedBallAdapter.this, val, selected);
    };
    ...
    public CalcNomalRedBallAdapter(Context context, int resId, boolean ignore, Set<String>list_select) {
        super(context, resId);
        this.ignore=ignore;
