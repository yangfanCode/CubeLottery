...
import com.cp2y.cube.activity.numlibrary.adapter.D3NumberAdapter;
 ...
 */
public class D3LibraryFragment extends Fragment {
    private D3NumberAdapter adapter = null;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new D3NumberAdapter(getActivity(),2);
        //添加头布局
    ...
    private void refreshData() {
        currPage = 0;
        NetHelper.LOTTERY_API.getNumberLibrary(LoginSPUtils.getInt("id",0), 10001, 0, ++currPage, 0)
