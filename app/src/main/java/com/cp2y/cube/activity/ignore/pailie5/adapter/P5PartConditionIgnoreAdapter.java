 ...
 */
public class P5PartConditionIgnoreAdapter extends BaseAdapter {
    ...
    public P5PartConditionIgnoreAdapter(Context context) {
    ...
    public int getCount() {
        ...
        } else if ((pos == 5 && tab == 1) || (pos == 6 && tab == 1)) {//奇偶 大小形态
            return list != null && list.size() == 5 ? (list.get(0).size() + list.get(1).size() + list.get(2).size() + list.get(3).size() + list.get(4).size() + 5) : 0;
        } else {//奇偶 大小比
    ...
    public int getItemViewType(int position) {
        ...
        if ((pos == 5 && tab == 0) || (pos == 6 && tab == 0)) {//正常布局
            ...
            } else if ((pos == 5 && tab == 1) || (pos == 6 && tab == 1)) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (type == 0) {//头布局
            ...
            try {
                ...
                if (pos == 5 || pos == 6) {//奇偶终端线
                    endLine.setVisibility(position == getCount() - 1 ? View.VISIBLE : View.GONE);//终端线
                }
                //tv_num.setTextSize(TypedValue.COMPLEX_UNIT_PX, (pos == 5 && tab == 1) ? context.getResources().getDimension(R.dimen.app_tvSmall_size) : context.getResources().getDimension(R.dimen.app_tvBall_size));
