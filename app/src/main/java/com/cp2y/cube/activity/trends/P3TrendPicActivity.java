...
import com.cp2y.cube.fragment.pailie3.P3BigTrendFragment;
...
import com.cp2y.cube.fragment.pailie3.P3SumMantissaTrendFragment;
...
public class P3TrendPicActivity extends BaseActivity {
    private AlertDialog dialog=null;
    private String lotteryName;
    private int pos;
    private PopupWindow popupWindow = null;
    private String[] title_array = {"定位走势", "振幅走势", "跨度走势", "除3余走势", "和值走势", "奇偶走势", "大小走势", "和尾数走势"};
    private static Class[] TREND_FRAGMENTS = {P3LocationTrendFragment.class, P3SwingTrendFragment.class, P3SpanTrendFragment.class, P3Chu3yuTrendFragment.class, P3SumTrendFragment.class, P3JiouTrendFragment.class, P3BigTrendFragment.class, P3SumMantissaTrendFragment.class};
    /**
     * 走势图
     **/
    ...
    private void ignoreListener() {
        ...
        if (pos == 2 ||  pos == 4 ||  pos == 7) {
            intent.setClass(P3TrendPicActivity.this, IgnoreP3Activity.class);
            intent.putExtra("pos", pos);
            startActivity(intent);
        } else if(pos==1){
            setTipDialog();
        }else{
            intent.setClass(P3TrendPicActivity.this, PartIgnoreP3Activity.class);
            intent.putExtra("pos", pos);
            startActivity(intent);
        }
    }
    ...
    public void showSubTitles() {
        if (popupWindow == null) {
            View contentView = LayoutInflater.from(P3TrendPicActivity.this)
