 ...
 */
public class Calc3DZhiXuanAdapter extends BaseAdapter {
    ...
    public Calc3DZhiXuanAdapter(Context context, boolean ignore, Set<String> list_select, int flag){
    ...
    private View.OnClickListener listener = view -> {//点击事件
        ...
        if (call != null) call.onBallSelected(Calc3DZhiXuanAdapter.this, val, selected);
    };
