 ...
 */
public class CalcP3ZhixuanFragment extends Fragment  implements BallSelectCall{
    ...
    private void numSet(int pos1, int pos2) {
        P3CalcFragment fragment= (P3CalcFragment) CalcP3ZhixuanFragment.this.getParentFragment();
...
//        }
        ...
        if (SingletonMapP3.getMapSize() >= 10 && isEdit == false) {
            ...
            if (type == 2) {//编辑模式
                SingletonMapP3.editDelete(fragment.getKey(), listfilter_zhixuan);
            } else if (type == 1) {//添加号码
                SingletonMapP3.registerService(SingletonMapP3.sign_sort + "_" + onClickFlag, listfilter_zhixuan);
                onClickFlag++;
