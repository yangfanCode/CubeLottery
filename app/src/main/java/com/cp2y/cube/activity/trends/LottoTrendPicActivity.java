...
import com.cp2y.cube.fragment.lotto.LottoBigTrendFragment;
import com.cp2y.cube.fragment.lotto.LottoChu3yuTrendFragment;
import com.cp2y.cube.fragment.lotto.LottoJiouTrendFragment;
import com.cp2y.cube.fragment.lotto.LottoLocationTrendFragment;
import com.cp2y.cube.fragment.lotto.LottoNumTrendFragment;
import com.cp2y.cube.fragment.lotto.LottoSpanTrendFragment;
import com.cp2y.cube.fragment.lotto.LottoSumMantissaTrendFragment;
import com.cp2y.cube.fragment.lotto.LottoSumTrendFragment;
...
public class LottoTrendPicActivity extends BaseActivity {
    private int pos;
    private String lotteryName;
    private PopupWindow popupWindow = null;
    private String[] title_array = {"号码走势", "定位走势", "跨度走势", "除3余走势", "和值走势", "奇偶走势","大小走势","和尾数走势"};
    private static Class[] TREND_FRAGMENTS = {LottoNumTrendFragment.class, LottoLocationTrendFragment.class, LottoSpanTrendFragment.class, LottoChu3yuTrendFragment.class, LottoSumTrendFragment.class, LottoJiouTrendFragment.class, LottoBigTrendFragment.class,LottoSumMantissaTrendFragment.class};
    /**
     * 走势图
     **/
    private GestureDetectorCompat mDetector;
    private ImageView pop_iv,ignore_iv,netOff;
    private Set<Integer> noIgnore=new HashSet<Integer>(){{add(1);}};//不显示遗漏的走势
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public boolean onDoubleTap(MotionEvent e) {
                getService(CommonService.class).runDelay(150).subscribe(new SafeOnlyNextSubscriber<Long>() {
                    ...
                    public void onNext(Long args) {
                        ...
                        TrendLottoBaseFragment fragment = (TrendLottoBaseFragment) getSupportFragmentManager().findFragmentByTag("TrendFragment");
        ...
        setContentView(R.layout.activity_lotto_trend_pic);
    ...
    private void ignoreListener() {
        ...
        if (pos == 3 ||  pos == 5||  pos == 6) {
            intent.setClass(LottoTrendPicActivity.this, PartIgnoreLottoActivity.class);
        } else {
            intent.setClass(LottoTrendPicActivity.this, IgnoreLottoActivity.class);
        }
    ...
    public void showSubTitles() {
        if (popupWindow == null) {
            View contentView = LayoutInflater.from(LottoTrendPicActivity.this)
