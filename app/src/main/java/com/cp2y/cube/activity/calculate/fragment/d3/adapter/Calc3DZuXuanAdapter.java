package com.cp2y.cube.activity.calculate.fragment.d3.adapter;
 ...
 */
public class Calc3DZuXuanAdapter extends BaseAdapter {
    ...
    public Calc3DZuXuanAdapter(Context context, boolean ignore, Set<String> list_select, Set<String> list_select_dantuo){
    ...
    private View.OnClickListener listener = view -> {
        ...
        if (call != null) isValid = call.onBeforeSelected(Calc3DZuXuanAdapter.this, val,false);
        if (!isValid) return;
        ...
        if (call != null) call.onBallSelected(Calc3DZuXuanAdapter.this, val, selected);
    };
    //长按监听
    private View.OnLongClickListener longClickListener=(v -> {
        ...
        //点击之前判断
        boolean isValid = true;
        if (call != null) isValid = call.onBeforeSelected(Calc3DZuXuanAdapter.this, val,true);
