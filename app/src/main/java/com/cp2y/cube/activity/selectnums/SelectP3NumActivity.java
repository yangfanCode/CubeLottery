...
import com.cp2y.cube.fragment.pailie3.P3ConditionFragment;
import com.cp2y.cube.fragment.pailie3.P3ZhiXuanFragment;
import com.cp2y.cube.fragment.pailie3.P3Zu3Fragment;
import com.cp2y.cube.fragment.pailie3.P3Zu6Fragment;
...
public class SelectP3NumActivity extends BaseActivity implements SensorEventListener {
    private int tabSelectPos = 0;
    private List<Fragment> list = new ArrayList<>();
    private Toolbar conditionBar, normalBar;
    private TabLayout tablayout;
    private FragmentManager fm = getSupportFragmentManager();
    private P3ConditionFragment conditionFragment = new P3ConditionFragment();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_select_p3_num);
        setMainTitle("过滤条件");
    ...
    private void initListener() {
        ...
        ignore.setOnClickListener(view -> {
            ...
            isIgnore = !isIgnore;
            P3ZhiXuanFragment fragment0 = (P3ZhiXuanFragment) list.get(0);
            fragment0.switchIgnore();
            P3Zu3Fragment fragment1 = (P3Zu3Fragment) list.get(1);
            fragment1.switchIgnore();
            P3Zu6Fragment fragment2 = (P3Zu6Fragment) list.get(2);
    ...
    private void switchDialog(int position) {
        AlertDialog.Builder builder = new AlertDialog.Builder(SelectP3NumActivity.this);
        View view = LayoutInflater.from(SelectP3NumActivity.this).inflate(R.layout.selectnum_3d_tabswitch, null);
    ...
    private void initData() {
        //遗漏接口数据
        NetHelper.LOTTERY_API.getD3CurrentLotteryMiss("10003")
        ...
        P3ZhiXuanFragment zhixuanFragment = new P3ZhiXuanFragment();
        P3Zu3Fragment zu3Fragment = new P3Zu3Fragment();
        P3Zu6Fragment zu6fragment = new P3Zu6Fragment();
    ...
    public void editData(List<String>list, String key, int keyNum){
        onBackPressed();
        P3ZhiXuanFragment fragment0 = (P3ZhiXuanFragment) this.list.get(0);
        P3Zu3Fragment fragment1 = (P3Zu3Fragment) this.list.get(1);
        P3Zu6Fragment fragment2 = (P3Zu6Fragment) this.list.get(2);
    ...
    protected void onDestroy() {
        ...
        //销毁清空数据 初始化
        SingletonMap3D.getMap().clear();
        SingletonMapFilter.getP3Map().clear();
