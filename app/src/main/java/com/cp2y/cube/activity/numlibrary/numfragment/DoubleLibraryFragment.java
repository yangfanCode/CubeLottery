...
import com.cp2y.cube.activity.numlibrary.adapter.NumberAdapter;
 ...
 */
public class DoubleLibraryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //删除号码库
        FileUtils.cleanInternalFiles(new File(FileUtils.DOUBLE_PATH));
        ...
        adapter = new NumberAdapter(getActivity());
        //添加头布局
    ...
    private void refreshData() {
        currPage = 0;
        NetHelper.LOTTERY_API.getNumberLibrary(LoginSPUtils.getInt("id",0), 10002, 0, ++currPage, 0)
    ...
    private void loadData() {
        ...
        NetHelper.LOTTERY_API.getNumberLibrary(id, 10002, 0, ++currPage, 0)
