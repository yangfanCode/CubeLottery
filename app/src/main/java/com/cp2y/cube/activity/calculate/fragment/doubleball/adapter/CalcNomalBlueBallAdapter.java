 ...
 */
public class CalcNomalBlueBallAdapter extends MyBaseAdapter<String> {
    ...
    private View.OnClickListener listener = view -> {
        ...
        if (call != null) call.onBallSelected(CalcNomalBlueBallAdapter.this, val, selected);
    };
    ...
    public CalcNomalBlueBallAdapter(Context context, int resId, boolean ignore, Set<String>list_select) {
        super(context, resId);
        this.ignore=ignore;
