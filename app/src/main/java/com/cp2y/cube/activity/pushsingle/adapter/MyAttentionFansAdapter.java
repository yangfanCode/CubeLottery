 ...
 */
public class MyAttentionFansAdapter extends BaseAdapter {
    ...
    private View.OnClickListener onClickListener=v -> {
        ...
        intent.putExtra("otherUserId",isAttention?list.get(position).getSubscribeUserId():list.get(position).getUserId());
        context.startActivity(intent);

    };
    public MyAttentionFansAdapter(Context context,boolean isAttention){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        button.setImageResource(detail.getType()==0?R.mipmap.xq_guanzhu:R.mipmap.xq_yiguanzhu);//关注状态
