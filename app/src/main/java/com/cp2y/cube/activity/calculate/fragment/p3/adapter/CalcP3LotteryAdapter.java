package com.cp2y.cube.activity.calculate.fragment.p3.adapter;
 ...
 */
public class CalcP3LotteryAdapter extends BaseAdapter {
...
//            }
//        });
//        treeMap2=(TreeMap<String, List<String>>) SingletonMapP3.getMap();
        entries.addAll(SingletonMapP3.getMap().entrySet());//键值对赋值
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        if (convertView == null) {
                if (type == 0) {//直选单式
                    ...
                    convertView = inflater.inflate(R.layout.item_zuxuan_single, viewGroup, false);
                }
            }
            Map.Entry<String, List<String>> entry = entries.get(position);
            List<String> list = entry.getValue();
            if (type == 0 || type == 7) {//直选单式 组选单式
                ...
                int pos[]=SingletonMapP3.findZhiXuanLocationIndex(list);
