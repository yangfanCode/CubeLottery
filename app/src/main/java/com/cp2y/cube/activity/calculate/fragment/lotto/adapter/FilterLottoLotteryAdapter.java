 ...
 */
public class FilterLottoLotteryAdapter extends BaseAdapter {
    /*0大乐透,1双色球*/
    private int flag=-1;
...
//            }
//        });
//        treeMap2=(TreeMap<String, List<String>>) SingletonMapLotto.getMap();
        entries.addAll(SingletonMapLotto.getMap().entrySet());
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        if (type == 0) {
            ...
            int pos = SingletonMapLotto.findMutiBlueIndex(list);
            ...
            if(flag==0){//双色球
                int[] pos = SingletonMapLotto.findDanTuoIndex(list);
                ...
                int[] pos = SingletonMapLotto.findLottoDanTuoIndex(list);
