...
/**
 * RecyclerView 和PullToRefresh 结合实现垂直方向的刷新效果
 * Created by dingzuoqiang on 2018/1/24.
 * 530858106@qq.com
 */
public class PullRefreshRecyclerViewV extends PullToRefreshBase<RecyclerView> {
    public PullRefreshRecyclerViewV(Context context, Mode mode) {
        super(context, mode);
    }

    public PullRefreshRecyclerViewV(Context context) {
        super(context);
    }

    public PullRefreshRecyclerViewV(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public PullRefreshRecyclerViewV(Context context, Mode mode, AnimationStyle animStyle) {
